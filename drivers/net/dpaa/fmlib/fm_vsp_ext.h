...
/**************************************************************************//**
 ...
 @Cautions      Allowed only following FM_VSP_Config() and before FM_VSP_Init().
*//***************************************************************************/
uint32_t FM_VSP_ConfigDmaSwapData(t_Handle h_FmVsp, e_FmDmaSwapOption swapData);
...
/**************************************************************************//**
 ...
 @Cautions      Allowed only following FM_VSP_Config() and before FM_VSP_Init().
*//***************************************************************************/
uint32_t FM_VSP_ConfigDmaIcCacheAttr(t_Handle            h_FmVsp,
...
/**************************************************************************//**
 ...
 @Cautions      Allowed only following FM_VSP_Config() and before FM_VSP_Init().
*//***************************************************************************/
uint32_t FM_VSP_ConfigDmaHdrAttr(t_Handle h_FmVsp, e_FmDmaCacheOption headerCacheAttr);
...
/**************************************************************************//**
 ...
 @Cautions      Allowed only following FM_VSP_Config() and before FM_VSP_Init().
*//***************************************************************************/
uint32_t FM_VSP_ConfigDmaScatterGatherAttr(t_Handle              h_FmVsp,
...
/**************************************************************************//**
 ...
 @Cautions      Allowed only following FM_VSP_Config() and before FM_VSP_Init().
*//***************************************************************************/
uint32_t FM_VSP_ConfigDmaWriteOptimize(t_Handle h_FmVsp, bool optimize);
...
/**************************************************************************//**
 ...
 @Cautions      Allowed only following FM_VSP_Config() and before FM_VSP_Init().
*//***************************************************************************/
uint32_t FM_VSP_ConfigBackupPools(t_Handle h_FmVsp, t_FmBackupBmPools *p_BackupBmPools);
