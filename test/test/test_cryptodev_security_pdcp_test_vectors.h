...
static struct pdcp_test_param pdcp_test_params[] = {
	...
	{
	 .name =
	 "PDCP User Plane with SNOW encryption Uplink with 18 bit SN",
	 .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
	 .auth_alg = 0,
	 .domain = RTE_SECURITY_PDCP_MODE_DATA,
	 .cipher_key_len = 16,
	...
	{
	 .name =
	 "PDCP User Plane with SNOW encryption Downlink with 18 bit SN",
	 .cipher_alg = RTE_CRYPTO_CIPHER_SNOW3G_UEA2,
	 .auth_alg = 0,
	 .domain = RTE_SECURITY_PDCP_MODE_DATA,
	 .cipher_key_len = 16,
	...
	{
	 .name =
	 "PDCP User Plane with AES encryption Uplink with 18 bit SN",
	 .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
	 .auth_alg = 0,
	 .domain = RTE_SECURITY_PDCP_MODE_DATA,
	 .cipher_key_len = 16,
	...
	{
	 .name =
	 "PDCP User Plane with AES encryption Downlink with 18 bit SN",
	 .cipher_alg = RTE_CRYPTO_CIPHER_AES_CTR,
	 .auth_alg = 0,
	 .domain = RTE_SECURITY_PDCP_MODE_DATA,
	 .cipher_key_len = 16,
